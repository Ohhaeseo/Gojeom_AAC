...
> ## ⚠️ 이 문서는 8/14 기준이다. **최신은 아래 세 개다.**
>
> | 문서 | 다루는 것 |
> | --- | --- |
> | **[docs/HANDOVER_2026-08-18.md](../docs/HANDOVER_2026-08-18.md)** | **최신.** 팀 피드백 반영 · 만 14세 확인·동의 · 목표 삭제/이름/순서 · 카테고리별 목표 입력 |
> | [docs/HANDOVER_2026-08-17.md](../docs/HANDOVER_2026-08-17.md) | 화면 연결 · 경로 B(진단 없이 루틴) · Google 웹 로그인 |
> | [docs/BACKEND_HANDOVER_2026-08-16.md](../docs/BACKEND_HANDOVER_2026-08-16.md) | 백엔드 안정성 (얼굴 검출 · 스토리지 삭제 큐 · V6/V7) |
>
> **이어받는 사람은 8/18 문서부터 읽는다.** 이 문서는 배경·설계 원칙·오답 노트를
> 찾을 때 참고한다. 아래 「3. 할 일」은 대부분 완료됐다 — 현재 목록은 8/18 문서 §4에 있다.
...
| | 상태 |
| --- | --- |
| 백엔드 | 엔드포인트 26개 · AI 6단계 전부 실동작 · 마이그레이션 **V1~V11** |
...
**아직 AGENTS.md에 옮기지 못한 것이 6건 있다.**

- N-10 · N-11 · N-12 — [8/17 문서 §5](../docs/HANDOVER_2026-08-17.md)
- N-13 · N-14 · N-15 · N-16 — [8/18 문서 §3](../docs/HANDOVER_2026-08-18.md)
...
- 밀린 커밋이 있는지는 `git log origin/backend..HEAD --oneline`으로 본다. 비어 있으면 전부 올라가 있다.
