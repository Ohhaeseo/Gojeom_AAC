...
export default function OptionalInfoScreen() {
  ...
  const { photoUri, priorities, profile, saveProfile } = useAppState();
...
const styles = StyleSheet.create({ content: { gap: spacing.md }, previous: { ...typography.h1, color: colors.textTertiary }, title: { ...typography.subtitle, color: colors.text }, description: { ...typography.body, color: colors.textMuted }, label: { ...typography.label, color: colors.text, marginTop: spacing.sm }, requiredMark: { color: colors.danger }, summaryCard: { flexDirection: 'row', gap: spacing.md, padding: spacing.md, borderRadius: radius.lg, backgroundColor: '#DFE7E5' }, summaryText: { flex: 1, ...typography.label, color: colors.textTertiary }, select: { height: 54, borderRadius: radius.md, paddingHorizontal: spacing.md, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: colors.surface }, selectText: { ...typography.body, color: colors.textTertiary }, options: { maxHeight: 220, borderRadius: radius.md, backgroundColor: colors.surface, overflow: 'hidden' }, option: { padding: 12 }, optionText: { ...typography.body, color: colors.textTertiary }, grid: { flexDirection: 'row', flexWrap: 'wrap', marginHorizontal: -5, padding: 10, borderRadius: radius.lg, backgroundColor: '#DFE7E5' }, half: { width: '50%', padding: 5 }, errorText: { ...typography.caption, color: colors.danger } });
