    ...
    <AppScreen navigation contentStyle={styles.content}>
      ...
      {capture ? (
        <View style={[styles.captureCard, capture.tone === 'warn' && styles.captureCardWarn]}>
          ...
          <Pressable accessibilityRole="button" accessibilityLabel="사진 다시 등록하기" onPress={() => router.push('/photo')} style={styles.smallButton}><Text style={styles.smallButtonText}>사진 다시 등록하기</Text></Pressable>
        </View>
      ) : null}
